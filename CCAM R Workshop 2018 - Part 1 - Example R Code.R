...
housing.test  <- housing[-rows.train,]  # rows in the test set
...
housing.training <- housing.training %>% mutate(PRICE = PRICE/1000)
...
plot1_colorchange <- plot1_minimal + scale_fill_manual(name = "Property Type", 
